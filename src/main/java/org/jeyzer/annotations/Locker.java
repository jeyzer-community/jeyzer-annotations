...
/**
 * <p>Generates a Jeyzer analysis pattern locker entry.<br>Example :</p>
 * <code>&lt;locker name=&quot;ReadLock&quot; pattern=&quot;java.util.concurrent.locks.ReentrantReadWriteLock$ReadLock.lock&quot; priority=&quot;900&quot; /&gt;</code>
 ...
 * <p>Pattern locker attributes are :
 * <ul>
 * <li>Name. It is either provided as annotation attribute or deduced from the element name.<br>
 *  For example, for a <code>acquireLock</code> method, name will be set as <i>Acquire lock</i>.<br>
...
public @interface Locker {
	/**
	 * The locker name. Optional
	 * @return the name
	 */
	String name() default "";
	/**
	 * The locker priority. Optional
	 * @return the priority
	 */
